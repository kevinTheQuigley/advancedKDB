...
.log4q.r[1;`INFO`DEBUG];
.log4q.a[hopen (hsym `$(cdir,"/logs/connections/",(-2_(first -1#"/" vs string(.z.f))),".log"));`INFO`DEBUG];

.z.po: {
        .log4q.INFO("USER: %1; CONNECTION: %2; OPEN";(.z.u;.z.w));
        .log4q.INFO(mem_usage),"\n"};

.z.pc: {
        .log4q.INFO("USER: %1; CONNECTION: %2; CLOSED";(.z.u;x));
        .log4q.INFO(mem_usage),"\n"};
